...
from models.utils import create_mlp_components, create_vtp_components

__all__ = ['VTPNet']


class VTPNet(nn.Module):
   
    blocks = ((64, 1, 32, 100, 0.03, 45), (128, 1, 16, 800, 0.01, 6), (64, 1, 32, 100, 0.03, 45), (128, 1, 16, 800, 0.01, 6), (512, 1, None, None, None, None), (2048, 1,None,  None, None, None))

    def __init__(self, num_classes, extra_feature_channels=6, width_multiplier=1, voxel_resolution_multiplier=1):
        super().__init__()
        self.in_channels = extra_feature_channels + 3

        layers, channels_point, concat_channels_point =  create_vtp_components(
        ...
        layers, channels_cloud = create_mlp_components(
            in_channels=channels_point, out_channels=[1024,512,256, 128], # 可添加
